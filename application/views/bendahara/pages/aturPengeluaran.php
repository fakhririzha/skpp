    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table" id="histori-pengeluaran">
              ...
              <?php foreach ($historiPemasukan as $trx) : ?>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-success text-white" href="<?= base_url() ?>bendahara/ubahPengeluaran?no_ref=<?= $trx->no_ref ?>"><i class="fas fa-pencil-alt"></i> Ubah</a>
                  </td>
                  <td class="text-center">
                    <button class="btn btn-danger text-white" data-toggle="modal" data-target="#hapus-pengeluaran-<?= $trx->no_ref ?>-modal"><i class="fas fa-trash-alt"></i> Hapus</button>
                    <!--  -->
                    <div class="modal fade" id="hapus-pengeluaran-<?= $trx->no_ref ?>-modal" tabindex="-1" role="dialog" aria-labelledby="hapus-kelas-modal-label" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="hapus-kelas-modal-label">Konfirmasi Hapus Transaksi Pengeluaran</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                            <p>Apakah anda yakin akan menghapus transaksi pengeluaran dengan No. Ref <?= $trx->no_ref ?> ?</p>
                            <p>Aksi ini tidak dapat dibatalkan setelah anda menekan tombol hapus!</p>
                          </div>
                          <div class="modal-footer">
                            <a href="<?= base_url() ?>bendahara/hapusPengeluaran?no_ref=<?= $trx->no_ref ?>" class="btn btn-danger text-white"> Hapus</a>
                            &nbsp;&nbsp;|&nbsp;&nbsp;
